...
const drawdownSections = rrSections;
const riskPerTradeSections = lotSizeSections;
const stopLossSections = rrSections;
const positionVsLotSections = lotSizeSections;
